...
const loginForm = document.querySelector('.form-box.login'); // Certifique-se de que a classe está correta
...
function handleLogin(e) {
    ...
    realizarRequisicaoAPI('POST', window.APIURL, userCredentials)
        .then(data => {
            console.log(data);
            /*
